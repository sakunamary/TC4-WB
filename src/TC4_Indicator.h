           ...
           // vTaskDelay(user_wifi.sampling_time / portTICK_RATE_MS); // dealy 1s showup
            ...
            init_countdown--;
                ...
                else
                {
                    ...
                    {
                        display.drawStringf(2 + 16, 0 + 2,buffer,"BT:%4.1f",temperature_data.BT_AvgTemp);
                        display.drawStringf(2 + 16, 18 + 2,buffer,"ET:%4.1f",temperature_data.ET_AvgTemp);
                        display.drawStringf(128-48-12, 0 + 2,buffer,"dB:%4.1f",temperature_data.BT_ROR);
                        display.drawStringf(128-48-12, 18 + 2,buffer,"dE:%4.1f",temperature_data.ET_ROR);
